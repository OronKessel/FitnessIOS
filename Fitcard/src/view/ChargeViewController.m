...
-(void) actionPay
{
    ...
    [self serviceChargeFund:cardNumber :cvv :month :year :self.editAmount.text ];
}
...
-(void) updateUserCredit
{
    ...
    [Globals saveUserInfo];
    UIAlertView *errDlg = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"messageCharge", @"") message:@"" delegate:self cancelButtonTitle:NSLocalizedString(@"close", @"") otherButtonTitles:nil, nil];
    [errDlg show];
