...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (bookMode == 1)
    {
        ...
        classCell.lblBookDate.text = [[[NSLocalizedString(@"date", @"") stringByAppendingString:[dateFormatter1 stringFromDate:bookDate]] stringByAppendingString:@" "] stringByAppendingString:[model.mStartHour substringWithRange:range]];
    ...
    else
    {
        ...
        gymCell.lblBookDate.text = [[[[[dateFormatter2 stringFromDate:bDate] stringByAppendingString:@" at "] stringByAppendingString:[dateFormatter3 stringFromDate:bDate]] stringByAppendingString:@"~"] stringByAppendingString:[dateFormatter3 stringFromDate:dateEightHoursAhead]];
