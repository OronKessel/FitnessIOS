...
-(void) addClasses
{
    ...
    double height = self.constraintHeightView.constant + 250 + 120 * lstClasses.count;
...
-(void) setBookButtonName
{
    ...
    NSString *strSuccess =[[[NSLocalizedString(@"success", @"") stringByAppendingString:@"\n"] stringByAppendingString:@"Code:"] stringByAppendingString:[(NSNumber*)mVisitCode stringValue]];
...
-(void) setData
{
    ...
    self.lblLocationGym.text = currentGym.mCity;
    self.lblDetailGymReview.text = [[[@"(" stringByAppendingString:[(NSNumber*)currentGym.mReview stringValue]] stringByAppendingString:NSLocalizedString(@"reviews", @"")] stringByAppendingString:@")"];
    ...
    self.constraintHeightView.constant = 171 + textViewSize.height;
